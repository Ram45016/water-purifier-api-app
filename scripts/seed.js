...
(async () => {
  try {
    ...
    await pool.query(`INSERT INTO admins (email, password_hash, name) VALUES ($1, $2, $3)
      ON CONFLICT (email) DO UPDATE SET password_hash = EXCLUDED.password_hash`, [adminEmail, hash, 'Admin User']);
    ...
    await pool.query(`
      INSERT INTO products (id, title, brand, sku, category_slug, price, mrp, rating, reviews, badge, thumbnail, tags) VALUES
